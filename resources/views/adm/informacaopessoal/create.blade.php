...
@endif
<form method="POST" action="{{url('infopessoal')}}">
    @csrf
    @method('POST')
    <div class="row">
    ...
    <div class="row">
        ...
        <input type="text" name="genero" id="genero" class="col-3" value="{{ old('genero') }}" />
    </div>
    <div class="row">
        <label class="col-2" for="pais">País</label>
        <input type="test" name="pais" id="pais" class="col-5" value="{{ old('pais') }}" />
    </div>
    <div class="row">
        <label class="col-2" for="escola">Nome da Escola</label>
        <input type="text" name="escola" id="escola" class="col-5" value="{{ old('escola') }}" />
    </div>
    <div class="row">
        <label class="col-2" for="cpf">CPF</label>
        <input type="text" name="cpf" id="cpf" class="col-4" value="{{ old('cpf') }}" />
    </div>
